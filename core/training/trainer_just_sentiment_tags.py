...
class ModelTrainer(object):
    ...
    def train_epoch(self, data_loader, report_step=100):
        ...
        for step, (batch_x, batch_len, batch_y, batch_x_tag) in enumerate(data_loader):
            ...
            pred_logits = self.model(batch_x_tag, batch_x_mask, batch_len)
    ...
    def train(self, n_epoch, train_loader, dev_loader=None, test_loader=None, epoch_lr_decay=5):
        # best_dev_acc = 0.
        # best_dev_loss = 1e30
        # best_test_acc = 0.
        # best_test_loss = 1e30
        ...
        for epoch_i in range(1, n_epoch + 1):
            ...
            if epoch_i > epoch_lr_decay:
                self.optimizer = lr_decay(self.optimizer, epoch_i-epoch_lr_decay, 0.03, self.lr)
            else:
    ...
    def test(data_loader, model, device):
        ...
        for (batch_x, batch_len, batch_y, batch_x_tag) in data_loader:
            ...
            try:
                output = model(batch_x_tag, batch_max, batch_len)
